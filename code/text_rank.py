...
def extractKeyphrases(text):
    ...
    text = str.decode(text, "UTF-8", "ignore")
...
def get_key_phrases(string):
    keyphrases = extractKeyphrases(string)
    summary = extractSentences(string)
    return (keyphrases, summary)

def get_only_phrases(string):
    return extractKeyPhrases(string)
